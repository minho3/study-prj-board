...
import com.study.prjboard.config.SecurityConfig;
import com.study.prjboard.config.TestSecurityConfig;
import com.study.prjboard.domain.constant.FormStatus;
import com.study.prjboard.domain.constant.SearchType;
...
import com.study.prjboard.dto.request.ArticleRequest;
import com.study.prjboard.dto.response.ArticleResponse;
import com.study.prjboard.service.ArticleService;
import com.study.prjboard.service.PaginationService;
import com.study.prjboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 수정 페이지 - 인증 없을땐 로그인 페이지")
    @Test
